...
# Set metadata labels
LABEL org.opencontainers.image.title="Terraform Apply GCP Action"
LABEL org.opencontainers.image.description="A GitHub Action that runs Terraform Apply inside a containerized environment with structured output, Google Cloud authentication, and dynamic secret handling."
